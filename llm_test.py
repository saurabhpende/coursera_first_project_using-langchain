...
call_all_models("You are a helpful assistant who provides concise and accurate answers", "How can I improve my coding with langchain? Tell me a cool fact about it as well")
